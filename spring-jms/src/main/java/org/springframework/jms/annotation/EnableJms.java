 ...
 *
 *     &#064;Override
 *     public void configureJmsListeners(JmsListenerEndpointRegistrar imports) {
 *         imports.setContainerFactory(myJmsListenerContainerFactory());
 *     }
 *
 *     &#064;Bean
 ...
 *     &#064;Override
 *     public void configureJmsListeners(JmsListenerEndpointRegistrar imports) {
 *         imports.setEndpointRegistry(myJmsListenerEndpointRegistry());
 *         imports.setMessageHandlerMethodFactory(myJmsHandlerMethodFactory);
 *     }
 *
 *     &#064;Bean
 ...
 *         imports.registerEndpoint(endpoint, anotherJmsListenerContainerFactory());
 *     }
 *
 *     &#064;Bean
 *     public MyService myService() {
